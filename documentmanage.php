...
if (isset($_POST['submit'])) {
  ...
  if (isset($_FILES['fileToUpload'])) {
    ...
    VALUES ('$name', '$target_name')";
          ...
          echo " <p class='msg'>Sorry, there was an error uploading your file.</p>";
        }
      }
    }
  }
...
<body>
  <label class="custom-upload">
    <form id="Docname" action="" method="post" enctype="multipart/form-data">
      <label> EnterDocument Name</label><input class="text1" type="text" name="text" placeholder="Enter document name"><br>
      Select documents to upload:
      <button class="btn1">
        <input class="text2" type="file" name="fileToUpload" id="fileToUpload">
        <input class="text2" type="submit" value="Upload Documents" name="submit"></button>
